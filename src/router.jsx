...
const AdminRecipesForm = lazy(
  () =>
    import("./pages/Admin/pages/AdminRecipes/pages/AdminRecipesForm/AdminRecipesForm"),
);
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: "list", element: <AdminRecipesList /> },
              { path: "new", element: <AdminRecipesForm /> },
              { path: "edit/:recipeId", element: <AdminRecipesForm /> },
            ],
          },
          {
            path: "users",
